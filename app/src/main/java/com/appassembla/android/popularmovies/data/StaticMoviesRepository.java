...
public class StaticMoviesRepository implements MoviesRepository {
    ...
    public StaticMoviesRepository() {
        Movie movie7 = Movie.create(7, "Movie 7", "", "Movie 7 is about Jedi", 0, new Date());

        Movie movie4 = Movie.create(4, "Movie 4", "", "Movie 4 is about an archaeologist", 0, new Date());

        Movie movie8 = Movie.create(8, "Movie 8", "", "Movie 8 is about an alien", 0, new Date());
