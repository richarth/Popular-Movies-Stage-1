...
public class WebMoviesRepositoryTest {
    ...
    public void verifyJsonConvertsToModel() throws Exception {
        ...
        Date movieDate = new SimpleDateFormat("yyyy-MM-dd").parse("2016-06-18");

        Movie sampleMovie = Movie.create(328111, "The Secret Life of Pets", "/aDNbXvuRiuYxk8qCwXNQQ7UEHau.jpg", "The quiet life of a terrier named Max is upended when his owner takes in Duke, a stray whom Max instantly dislikes.", 5.8, movieDate);
