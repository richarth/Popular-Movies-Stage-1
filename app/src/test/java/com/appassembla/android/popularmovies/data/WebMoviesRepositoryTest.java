...
public class WebMoviesRepositoryTest {
    ...
    public void verifyJsonConvertsToModel() throws Exception {
        ...
        Movie sampleMovie = Movie.create(328111, "The Secret Life of Pets", "/WLQN5aiQG8wc9SeKwixW7pAR8K.jpg", "The quiet life of a terrier named Max is upended when his owner takes in Duke, a stray whom Max instantly dislikes.", 5.8, "2016-06-18");
